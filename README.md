...
<div class="highlighter-rouge"><pre class="highlight"><code>let g:office_dark_CursorLineNr = 'off'
...
<div class="highlighter-rouge"><pre class="highlight"><code>let g:office_dark_LineNr = 'off'
