...
if !has('gui_running')
  execute "silent !/bin/sh $HOME/.nightshell/9009-light"
endif
...
if has("nvim")
  ...
  let g:terminal_color_10 = "#e8e7e1"
  let g:terminal_color_11 = "#bfbeb8"
  let g:terminal_color_12 = "#706e63"
  let g:terminal_color_13 = "#302f26"
  let g:terminal_color_14 = "#d48e99"
  let g:terminal_color_15 = "#1f1d17"
